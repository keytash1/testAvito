...
-
"Пользователь с isActive = false не должен назначаться на ревью". Но нет явного требования автоматически переназначать уже назначенных ревьюверов при деактивации, поэтому я не добавил данную логику