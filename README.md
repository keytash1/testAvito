...
1. При создании PR автоматически назначаются **до двух** активных ревьюверов из **команды автора**, исключая самого автора. Переназначение заменяет одного ревьювера на случайного **активного** участника **из команды заменяемого** ревьювера.
...
2. "Пользователь с isActive = false не должен назначаться на ревью". 

Но нет явного требования автоматически переназначать уже назначенных ревьюверов при деактивации, поэтому я не добавил данную логику